 ...
 * 5、js交互与安全
 */
public class WebViewAPIActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_view_api);
    ...
    void setWebViewChromeClient() {
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
                ...
                Toast.makeText(WebViewAPIActivity.this, message, Toast.LENGTH_SHORT).show();
    ...
    private class JsCallAndroidInterface {
        ...
        public void callback(String msg) {
            Toast.makeText(WebViewAPIActivity.this, "JS方法回调到web了 ：" + msg, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private boolean resolveShouldLoadLogic(String url) {
        ...
        if (uri.getScheme().equals("js")) {
            if (uri.getAuthority().equals("Authority")) {
                ...
                Toast.makeText(WebViewAPIActivity.this, "JS 2方法回调到web了", Toast.LENGTH_SHORT).show();
    ...
    private boolean resolveJSPrompt(String message) {
        ...
        if ( uri.getScheme().equals("js")) {
            if (uri.getAuthority().equals("Authority")) {
                ...
                Toast.makeText(WebViewAPIActivity.this, "JS 3方法回调到web了", Toast.LENGTH_SHORT).show();
            }
            return true;
        }
