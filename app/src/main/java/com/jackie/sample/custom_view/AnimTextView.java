...
public class AnimTextView<T> extends View {
    ...
    public AnimTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.AnimTextView_textSize, DensityUtils.dp2px(context, 14));
    ...
    public void setText(T paramEndText) {
        ...
        mTextWidth = DensityUtils.getTextWidth(String.valueOf(mEndText), mTextPaint);
        mTextHeight = DensityUtils.getTextHeight(String.valueOf(mEndText), mTextPaint);
    ...
    private void startAnim() {
        ...
        if (mIsInteger) {
            valueAnimator = ValueAnimator.ofInt(0, (Integer) mEndText);
        } else {
            valueAnimator = ValueAnimator.ofFloat(0, Float.parseFloat(String.valueOf(mEndText)));
        }
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                mDrawText = mIsInteger ? (T) animation.getAnimatedValue() : (T) mDecimalFormat.format(animation.getAnimatedValue());
