...
public class ToggleButton extends View {
	...
	/** 开启颜色*/
	private int onColor = Color.parseColor("#4470FF");
	/** 关闭颜色*/
	private int offBorderColor = Color.parseColor("#E7E8EB");
	/** 灰色带颜色*/
	private int offColor = Color.parseColor("#E7E8EB");
	/** 手柄颜色*/
...
//		}
	...
	private void calculateEffect(final double value) {
		...
		final int tb = Color.blue(getOffBorderColor());
		final int tr = Color.red(getOffBorderColor());
		final int tg = Color.green(getOffBorderColor());
