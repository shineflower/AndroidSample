package com.jackie.sample.card_swipe;
...
import com.jackie.sample.card_swipe.view.SwipeFlingAdapterView;
...
public class CardSwipeActivity extends AppCompatActivity implements SwipeFlingAdapterView.OnFlingListener,
    ...
    private void initView() {
        ...
        View v = findViewById(R.id.swipe_left);
        if (v != null) {
            v.setOnClickListener(this);
        }

        v = findViewById(R.id.swipe_right);
        if (v != null) {
            v.setOnClickListener(this);
        }
...
//                swipeView.swipeRight(250);
    ...
    private void loadData() {
        new AsyncTask<Void, Void, List<Talent>>() {
            ...
            protected List<Talent> doInBackground(Void... params) {
                List<Talent> list = new ArrayList<>(10);
                Talent talent;
                for (int i = 0; i < 10; i++) {
                    talent = new Talent();
    ...
    private class InnerAdapter extends BaseAdapter {
        ...
        public Talent getItem(int position) {
            if(objs == null || (objs != null && objs.size() == 0)) return null;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card_swipe, parent, false);
